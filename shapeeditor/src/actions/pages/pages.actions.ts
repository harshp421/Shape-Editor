...
import { getTriangleDefaultProps } from "../../shapes/triangle";
...
export const addShape: (shape: ADD_SHAPE_PAYLOAD) => ADD_SHAPE_ACTION | undefined = ({ shape, x, y, pointsArray = [], src = '' }: ADD_SHAPE_PAYLOAD) => {
    ...
    switch (shape) {
        ...
        case SHAPE_TYPES.TRIANGLE: {
            newShapeDefaultProps = getTriangleDefaultProps(pointsArray as [[number, number], [number, number], [number, number]]);
            break;
        }
        default: return;
    }

...
export interface HISTORY_STATE {
    past: Array<SHAPE_COLLECTION[]>;
    present: SHAPE_COLLECTION[];
    future: Array<SHAPE_COLLECTION[]>;
}
...
//redu and undu selected shapes
export type REDU_SELECTED_SHAPES_ACTION = ACTION<PAGES_ACTION_TYPES.REDU_SELECTED_SHAPES, undefined>;
export type UNDO_SELECTED_SHAPES_ACTION = ACTION<PAGES_ACTION_TYPES.UNDO_SELECTED_SHAPES, undefined>;
// rename shape
